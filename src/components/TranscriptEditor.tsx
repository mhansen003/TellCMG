  ...
  return (
    <div>
      <div className="relative group">
          ...
          <textarea
            ...
            className={`
              ...
              ${isDragging
                ...
                : isListening
                  ? "border-cmg-blue/50 bg-cmg-glow"
                  : "border-border-subtle hover:border-cmg-blue/30 focus:border-cmg-blue/50"
              }
            `}
          />
              ...
              <button
                ...
                className={`p-1.5 rounded-lg transition-colors ${
                  copied
                    ...
                    : "bg-bg-elevated/80 text-text-muted hover:text-cmg-blue hover:bg-cmg-blue/10"
                }`}
        ...
        {/* Recording indicator */}
        {isListening && (
          <div className="absolute -top-1 -right-1 flex items-center gap-1.5 px-2 py-1 rounded-full bg-cmg-blue text-white text-xs font-semibold">
