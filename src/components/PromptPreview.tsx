    ...
    <div className="px-4 md:px-0 py-4 animate-fade_in">
      <div className="relative">
        ...
        <div className="relative group">
          <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-cmg-blue/20 to-cmg-deep/10 blur-xl opacity-50" />
          <div className="relative bg-bg-card border-2 border-cmg-blue/30 rounded-xl p-5 overflow-hidden">
            {/* Decorative corner */}
            <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-bl from-cmg-blue/10 to-transparent" />
